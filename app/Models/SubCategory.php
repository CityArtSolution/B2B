...
class SubCategory extends Model
{
    ...
    {
        return $this->hasMany(TranslateUtility::class , 'sub_category_id');
    }
    ...
    public function getTranslatedNameARAttribute()
    {
        $translation = $this->translations()->where('lang', 'ar')->first();
        return $translation->name ?? $this->name;
    }
