...
class ProductRepository extends Repository
{
    ...
    public static function storeByRequest(ProductRequest $request): Product
    {
        ...
        foreach ($request->branches as $branchId => $QTY) {
        ...
        $short_descriptions = [
            ...
            'ur' => $request->short_description_ur,
            'In' => $request->short_description_in,
        ];
        ...
        foreach ($names ?? [] as $key => $value) {
            ...
            $shortDescription = $short_descriptions[$key] ?? null;
