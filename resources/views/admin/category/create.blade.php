            ...
            <div class="col-lg-8 m-auto">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <x-input label="Name (AR)" name="name_ar" type="text" placeholder="Enter Name" required="true"/>
                        </div>
                        <div class="mt-3">
                            <x-input label="Name (EN)" name="name" type="text" placeholder="Enter Name" required="true"/>
                        </div>
                        <div class="mt-3">
                            <x-input label="Name (UR)" name="name_ur" type="text" placeholder="Enter Name" required="true"/>
                        </div>
                        <div class="mt-3">
                            <x-input label="Name (IN)" name="name_in" type="text" placeholder="Enter Name" required="true"/>
                        </div>
