                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control solid"
                                                            placeholder="{{ $menu->name[app()->getLocale()] }}"
                                                            value="{{ $menu->name[app()->getLocale()] }}" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="mb-3">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text"
                                                                                class="form-control solid"
                                                                                placeholder="{{ $menu->name['ar'] }}"
                                                                                name="menu_nameAR"
                                                                                value="{{ $menu->name['ar'] }}" required />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xl-6">
                                                                        <div class="mb-3">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="">
                                <x-input type="text" label="Navigation Label AR" placeholder="Enter Navigation Label AR"
                                    name="nameAR" required="true" />
                                    
                                <x-input type="text" label="Navigation Label EN" placeholder="Enter Navigation Label EN"
