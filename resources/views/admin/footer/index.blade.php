                        ...
                        <div class="allMenu-list d-flex flex-column gap-2">
                            @foreach ($menus as $menu)
                                <div class="allMenu-item" data-id="{{ $menu->id }}" data-type="menu">
                                    ...
                                    <div>
                                        {{ $menu->name[app()->getLocale()] ?? $menu->name['en']}}
                                    </div>
                                </div>
                            @endforeach
                        </div>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed fw-semibold fz-18"
                                                        ...
                                                        {{ $footer->title[app()->getLocale()] ?? $footer->title['en'] }}
                                                    </button>
                                                </h2>
                                                <div id="accordionTitle{{ $footer->id }}" class="accordion-collapse collapse">
                                                    <div class="accordion-body border">
                                                        <form action="{{ route('admin.footer.update', $footer->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <x-input name="title_ar" label="Title (AR)" type="text" class="form-control-sm"
                                                                value="{{ $footer->title['ar'] }}" placeholder="Enter Title"
                                                                required="true" />
                                                                
                                                            <x-input name="title" label="Title (EN)" type="text" class="form-control-sm"
                                                                value="{{ $footer->title['en'] }}" placeholder="Enter Title"
                                                                required="true" />
                                                                ...
                                                                <div class="row">
                                                                    @if ($item->type == 'email' || $item->type == 'phone')
                                                                        <div class="col-12 mb-3">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                placeholder=""
                                                                                value="{{ $item->title[app()->getLocale()] ?? $item->title['en'] }}" required />
                                                                        </div>
                                                                    @elseif ($item->type == 'text')
                                                                        <div class="col-12 mb-3">
                                                                            ...
                                                                            <textarea name="title_ar" class="form-control form-control-sm" placeholder="short text" required>{{ $item->title['ar']}}</textarea>
                                                                        </div>
                                                                        <div class="col-12 mb-3">
                                                                            <label class="form-label mb-1">
                                                                                {{ __('Short Text (EN)') }}
                                                                            </label>
                                                                            <textarea name="title" class="form-control form-control-sm" placeholder="short text" required>{{ $item->title['en']}}</textarea>
                                                                        </div>
                                                                    @else
                                                                        <div class="col-12 mb-3">
                                                                            <label class="form-label mb-1">
                                                                                {{ __('Navigation Label (AR)') }}
                                                                            </label>
                                                                            <input type="text"
                                                                                class="form-control form-control-sm"
