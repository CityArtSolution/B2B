    ...
    <div class="container-fluid mt-3">
        ...
        <div class="alert alert-info impotentNote">
            ...
            <p style="font-size: 1.1em; line-height: 1.5;">
                {{ __("Just a quick note: VAT and Taxes are calculated based on your order. If you have multiple VAT and Tax rates active, your total VAT and Tax amount will be clearly displayed on the checkout page for your convenience.") }}
            </p>
        </div>
