                                    ...
                                    <div class="border rounded-3 overflow-hidden">
                                        ...
                                        <div class="p-3 d-flex flex-column gap-3 bg-white">
                                            @foreach ($allPermissions as $permissionName => $permissionValues)
                                                @if (!in_array($permissionName, ['bulk-product-export', 'bulk-product-import', 'gallery', 'notification' , 'review' , 'business-setting' , 'verification' , 'socialLink'  , 'socialAuth' , 'menu' , 'page' , 'country' , 'currency' , 'themeColor' , 'pusher' , 'mailConfig' , 'paymentGateway' , 'sms-gateway' , 'googleReCaptcha' , 'firebase' , 'customerNotification' , 'language' , 'aiPrompt' , 'ticketIssueType' , 'supportTicket']))
                                                <div class="border rounded-3 permission-item">
                                                    ...
                                                    <div class="fz-18 d-flex align-items-center flex-wrap gap-3 p-3">
                                                        @foreach ($permissionValues as $permission)
                                                            @if (!in_array($permission, ['generate.AI.data' , 'getMessageAdmin' , 'sendMessageAdmin']))
                                                            <div class="d-flex align-items-center gap-2">
                                                                <input type="checkbox"
