        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="px-3 py-2 d-flex justify-content-between align-items-center flex-wrap gap-2 border-bottom">
                    <div class="text-color">{{ __('Shipping methods') }}</div>
                    <div class="dropdown">
                                ...
                                @else
                                    <form action="{{ route('admin.order.uploadInvoice', $order->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <label class="upload-btn">
                                            <input type="file" name="delivered_invoice" onchange="this.form.submit()" hidden>
                                            <span>
                                                <img src="{{asset('assets/icons-admin/upload-svgrepo-com.svg')}}" style="width: 20px;">
                                                {{ __('Upload Invoice') }}
                                            </span>
                                        </label>
                                    </form>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title fs-5">{{ __('Choose a shipping company') }}</h3>
