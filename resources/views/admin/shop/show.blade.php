...
@section('content')
  <style>
    .btn-img { background:#4CAF50; color:white; padding:10px 18px; border:none; border-radius:6px; cursor:pointer; font-size:16px; }
    /* Modal */
    .modal-img {
    ...
    .modal-content-img {
      background: white; padding: 12px; border-radius:10px; max-width:90%; max-height:90%;
      box-shadow: 0 10px 30px rgba(0,0,0,0.25); display:flex; flex-direction:column; gap:8px;
    }
    .modal-header-img { display:flex; justify-content:flex-end; }
    .close {
      background:transparent; border:none; font-size:22px; cursor:pointer; padding:6px;
    }
    .modal-body-img { display:flex; align-items:center; justify-content:center; overflow:auto; }
    .modal-body-img img { max-width:100%; max-height:75vh; border-radius:8px; }
  </style>
    <div class="container-fluid">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body pt-0">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <td style="width: 180px">{{ __('commercial register') }}:</td>
                                        <td>  <button id="openBtn"     data-img="{{ asset('storage/' . $shop->commercialRegister?->src) }}" class="btn-img">{{ __('show commercial register') }}</button></td>
                                    </tr>
                                    <tr>
      ...
      <div id="imgModal" class="modal-img" aria-hidden="true" role="dialog" aria-label="عرض الصورة">
        <div class="modal-content-img" role="document">
          <div class="modal-header-img">
            <button id="closeBtn" class="close" aria-label="إغلاق">✕</button>
          </div>
...
<script>
  ...
  openBtn.addEventListener('click', () => {
    const imgSrc = openBtn.getAttribute('data-img');
