...
<li>
    <a class="menu {{ $request->routeIs('admin.branch.*') ? 'active' : '' }}"
        href="{{ route('admin.branch.index') }}">
        <span>
            <img class="menu-icon" src="{{ asset('assets/icons-admin/git-branch-bold-svgrepo-com.svg') }}" alt="icon" loading="lazy" />
...
@hasPermission('admin.order.index')
    <li>
        <a class="menu {{ request()->routeIs('admin.order.*') ? 'active' : '' }}" data-bs-toggle="collapse" href="#OrderManagement">
            <span>
...
@hasPermission(['admin.rider.index', 'admin.rider.create'])
    ...
    <li>
        <a class="menu {{ request()->routeIs('admin.rider.*') ? 'active' : '' }}" data-bs-toggle="collapse"
            href="#riderMenu">
            <span>
                <img class="menu-icon" src="{{ asset('assets/icons-admin/truck-svgrepo-com.svg') }}" alt="icon"
                    loading="lazy" />
