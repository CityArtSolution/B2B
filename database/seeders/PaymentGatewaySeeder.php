    ...
    public function run(): void
    {
        ...
        $paymentMethods = [
            [
                ...
                'name' => 'stripe',
                'config' => json_encode([
                    'secret_key' => 'REDACTED51LQPRBI8v6B8L0HsH8JBOEoUuzy0OMkhiOeqfiei1AHEkZBUnmcf7Cv5Go6fwhi3HYayZgjeLxjDsP0DYHcR0xJ1008GRte5Vf',
            ...
            [
                ...
                'config' => json_encode([
                    ...
                    'secret_key' => 'REDACTED12498c55ac75a902a8ebe908f4e5108790e6e93c',
                    'machant_email' => '',
                ]),
                'mode' => 'test',
                'alias' => 'PayStack',
